...
IPM_REGION_4c_WHEAT = SUM_IPM_REGION_4c[SUM_IPM_REGION_4c$crop=="W",]

# remove crop col
IPM_REGION_4c_MAIZE = dplyr::select(IPM_REGION_4c_MAIZE,-crop)
IPM_REGION_4c_RICE = dplyr::select(IPM_REGION_4c_RICE,-crop)
IPM_REGION_4c_WHEAT = dplyr::select(IPM_REGION_4c_WHEAT,-crop)
...
IPM_REGION_4c_WHEAT = IPM_REGION_4c_WHEAT[,cols]
...
IPM_REGION_4c_WHEAT$range.2 =paste(IPM_REGION_4c_WHEAT$min.2,IPM_REGION_4c_WHEAT$max.2,sep=",")
IPM_REGION_4c_WHEAT$range.3 =paste(IPM_REGION_4c_WHEAT$min.3,IPM_REGION_4c_WHEAT$max.3,sep=",")
IPM_REGION_4c_WHEAT$range.4 =paste(IPM_REGION_4c_WHEAT$min.4,IPM_REGION_4c_WHEAT$max.4,sep=",")
...
IPM_REGION_4c_WHEAT = dplyr::select(IPM_REGION_4c_WHEAT,-one_of(rem))
rm(rem)
...
IPM_REGION_4c_WHEAT = IPM_REGION_4c_WHEAT[order(IPM_REGION_4c_WHEAT$median.2,decreasing = T),]
...
write.csv(IPM_REGION_4c_WHEAT, file.path(wdtables,"ST1_IPM_REGION_4c_WHEAT.csv"),row.names=F)

rm(IPM_REGION_4c_MAIZE)
rm(IPM_REGION_4c_RICE)
rm(IPM_REGION_4c_WHEAT)
...
TONNES_REGION_4c_WHEAT = SUM_TONNES_REGION_4c[SUM_TONNES_REGION_4c$crop=="W",]
...
TONNES_REGION_4c_WHEAT = TONNES_REGION_4c_WHEAT[,-which(colnames(TONNES_REGION_4c_WHEAT) %in% "crop", arr.ind=T)]
...
TONNES_REGION_4c_WHEAT$present =TONNES_REGION_PRES_WHEAT$sum
...
TONNES_REGION_4c_WHEAT = TONNES_REGION_4c_WHEAT[order(TONNES_REGION_4c_WHEAT$present,decreasing = T),]
...
TONNES_REGION_4c_WHEAT = TONNES_REGION_4c_WHEAT[,cols]
rm(cols)
...
write.csv(TONNES_REGION_4c_WHEAT, file.path(wdtables,"ST2_TONNES_REGION_4c_WHEAT.csv"),row.names=F)

rm(TONNES_REGION_4c_MAIZE)
rm(TONNES_REGION_4c_RICE)
rm(TONNES_REGION_4c_WHEAT)
...
YLPH_REGION_4c_WHEAT = SUM_YLPH_REGION_4c[SUM_YLPH_REGION_4c$crop=="W",]
...
YLPH_REGION_4c_WHEAT = dplyr::select(YLPH_REGION_4c_WHEAT,-crop)
...
YLPH_REGION_4c_WHEAT = YLPH_REGION_4c_WHEAT[,cols]
rm(cols)
...
YLPH_REGION_4c_WHEAT$range.2 =paste(YLPH_REGION_4c_WHEAT$min.2,YLPH_REGION_4c_WHEAT$max.2,sep=",")
YLPH_REGION_4c_WHEAT$range.3 =paste(YLPH_REGION_4c_WHEAT$min.3,YLPH_REGION_4c_WHEAT$max.3,sep=",")
YLPH_REGION_4c_WHEAT$range.4 =paste(YLPH_REGION_4c_WHEAT$min.4,YLPH_REGION_4c_WHEAT$max.4,sep=",")
...
YLPH_REGION_4c_WHEAT = dplyr::right_join(YL_REGION_PRES_WHEAT,YLPH_REGION_4c_WHEAT,by = "region")
...
YLPH_REGION_4c_WHEAT = dplyr::select(YLPH_REGION_4c_WHEAT,-one_of(rem))
rm(rem)
...
YLPH_REGION_4c_WHEAT = dplyr::arrange(YLPH_REGION_4c_WHEAT, desc(median))
...
write.csv(YLPH_REGION_4c_WHEAT, file.path(wdtables,"ST3_YLPH_REGION_4c_WHEAT.csv"),row.names=F)

# remove unused
rm(YLPH_REGION_4c_MAIZE)
rm(YLPH_REGION_4c_RICE)
rm(YLPH_REGION_4c_WHEAT)
...
IYCC_REGION_4c_WHEAT$range.2 =paste(IYCC_REGION_4c_WHEAT$min.2,IYCC_REGION_4c_WHEAT$max.2,sep=",")
IYCC_REGION_4c_WHEAT$range.3 =paste(IYCC_REGION_4c_WHEAT$min.3,IYCC_REGION_4c_WHEAT$max.3,sep=",")
IYCC_REGION_4c_WHEAT$range.4 =paste(IYCC_REGION_4c_WHEAT$min.4,IYCC_REGION_4c_WHEAT$max.4,sep=",")
...
IYCC_REGION_4c_WHEAT = dplyr::select(IYCC_REGION_4c_WHEAT,-one_of(rem))
rm(rem)
...
IYCC_REGION_4c_WHEAT = IYCC_REGION_4c_WHEAT[order(IYCC_REGION_4c_WHEAT$median.2,decreasing = T),]
...
write.csv(IYCC_REGION_4c_WHEAT, file.path(wdtables,"ST4_IYCC_REGION_4c_WHEAT.csv"),row.names=F)

# remove unused
rm(IYCC_REGION_4c_MAIZE)
rm(IYCC_REGION_4c_RICE)
rm(IYCC_REGION_4c_WHEAT)
