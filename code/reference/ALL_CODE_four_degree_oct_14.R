#Some highlights, or an index, if you like

# to start with All pre-made, first run through line 50, then skip to 678 and 679.

# to remake all, start at top, but hide lines 678 and 679.

#graphics start at 686 (but you need ALL4)
#maps start at 686
#median lines start at 903
# Fig 2 maps 992
# Supp. Fig Phi (all crops at all phis):  1024

#### NOTES FOR NEW 2DEGEEE WORLD RUN....
#CHECK LINE 365 - ADDING COUNTRY NAMES
#CHECK LINE 455, 1235 AND 2672  - MAKE SURE THE COUNTRY TO REGION NAMES ARE IN THE CORRECT DIRECTORY, AND THE SWTWD IS CORRECT
...
source("~/Dropbox/tewkslab/stats (r code)/functions/color bar.R")
source("~/Dropbox/tewkslab/stats (r code)/functions/summarySE function.R")
source("~/Dropbox/tewkslab/stats (r code)/functions/multiplot.R")

setwd("~/Dropbox/climate change/pest MS shared/Impact_4degC")
...
#I THINK THE CGS DATA ARE NOT CORRECT COMING IN. PLOT THEM...
#note, we do not expand the growing season with temp change in our model.
#renaming variables
...
############################ MERGING TO ALL4 TO FIX HOTSPOTS

ALL4<-merge(IPMIY,METPOP, by=c("LAT","LON"),all=TRUE,sort=TRUE)

#hotspots are areas where IPM and POP predicts insects eating more crop than is in the field. 
#this problem is caused primarily by poor data resolution in the crop growing season variable.
#If we had better data there, we would likely NOT have many cases like these.

#start by breaking into crops to remove NAs.
ALL4_M<-subset(ALL4,!is.na(ALL4$IPM_M2),select=c(LAT,LON,IPM_M2,IPM_M3,IPM_M4,IY_M2,IY_M3,IY_M4,CLF_M,CL_M,CY_M,CA_M,CGS_M,MET_M2,MET_M3,MET_M4,POP_M2,POP_M3,POP_M4))
#now reset values of IPM in which projected needs is greater than crops present, so that they limit at 
#crops present
ALL4_M$IPM_M2[ALL4_M$IPM_M2*ALL4_M$CLF_M>1]<-1/(ALL4_M$CLF_M)[ALL4_M$IPM_M2*ALL4_M$CLF_M>1]  
ALL4_M$IPM_M3[ALL4_M$IPM_M3*ALL4_M$CLF_M>1]<-1/(ALL4_M$CLF_M)[ALL4_M$IPM_M3*ALL4_M$CLF_M>1]
ALL4_M$IPM_M4[ALL4_M$IPM_M4*ALL4_M$CLF_M>1]<-1/(ALL4_M$CLF_M)[ALL4_M$IPM_M4*ALL4_M$CLF_M>1]
#now reset the values of POP as the difference between the NEW IPM and MET (caps pop at level that would sustain IPM)
ALL4_M$POP_M2[ALL4_M$IPM_M2*ALL4_M$CLF_M1>1]<-(ALL4_M$IPM_M2-ALL4_M$MET_M2)[ALL4_M$IPM_M2*ALL4_M$CLF_M>1]
ALL4_M$POP_M3[ALL4_M$IPM_M3*ALL4_M$CLF_M1>1]<-(ALL4_M$IPM_M3-ALL4_M$MET_M3)[ALL4_M$IPM_M3*ALL4_M$CLF_M>1]
ALL4_M$POP_M4[ALL4_M$IPM_M4*ALL4_M$CLF_M>1]<-(ALL4_M$IPM_M4-ALL4_M$MET_M4)[ALL4_M$IPM_M4*ALL4_M$CLF_M>1]

#Now repeat for rice and wheat
ALL4_R<-subset(ALL4,!is.na(ALL4$IPM_R2),select=c(LAT,LON,IPM_R2,IPM_R3,IPM_R4,+
  IY_R2,IY_R3,IY_R4,CLF_R,CL_R,CY_R,CA_R,CGS_R,MET_R2,MET_R3,MET_R4,POP_R2,POP_R3,POP_R4))

ALL4_R$IPM_R2[ALL4_R$IPM_R2*ALL4_R$CLF_R>1]<-1/(ALL4_R$CLF_R)[ALL4_R$IPM_R2*ALL4_R$CLF_R>1]  
ALL4_R$IPM_R3[ALL4_R$IPM_R3*ALL4_R$CLF_R>1]<-1/(ALL4_R$CLF_R)[ALL4_R$IPM_R3*ALL4_R$CLF_R>1]
ALL4_R$IPM_R4[ALL4_R$IPM_R4*ALL4_R$CLF_R>1]<-1/(ALL4_R$CLF_R)[ALL4_R$IPM_R4*ALL4_R$CLF_R>1]

ALL4_R$POP_R2[ALL4_R$IPM_R2*ALL4_R$CLF_R1>1]<-(ALL4_R$IPM_R2-ALL4_R$MET_R2)[ALL4_R$IPM_R2*ALL4_R$CLF_R>1]
ALL4_R$POP_R3[ALL4_R$IPM_R3*ALL4_R$CLF_R1>1]<-(ALL4_R$IPM_R3-ALL4_R$MET_R3)[ALL4_R$IPM_R3*ALL4_R$CLF_R>1]
ALL4_R$POP_R4[ALL4_R$IPM_R4*ALL4_R$CLF_R>1]<-(ALL4_R$IPM_R4-ALL4_R$MET_R4)[ALL4_R$IPM_R4*ALL4_R$CLF_R>1]

ALL4_W<-subset(ALL4,!is.na(ALL4$IPM_W2),select=c(LAT,LON,IPM_W2,IPM_W3,IPM_W4,+
 IY_W2,IY_W3,IY_W4,CLF_W,CL_W,CY_W,CA_W,CGS_W,MET_W2,MET_W3,MET_W4,POP_W2,POP_W3,POP_W4))

ALL4_W$IPM_W2[ALL4_W$IPM_W2*ALL4_W$CLF_W>1]<-1/(ALL4_W$CLF_W)[ALL4_W$IPM_W2*ALL4_W$CLF_W>1]  
ALL4_W$IPM_W3[ALL4_W$IPM_W3*ALL4_W$CLF_W>1]<-1/(ALL4_W$CLF_W)[ALL4_W$IPM_W3*ALL4_W$CLF_W>1]
ALL4_W$IPM_W4[ALL4_W$IPM_W4*ALL4_W$CLF_W>1]<-1/(ALL4_W$CLF_W)[ALL4_W$IPM_W4*ALL4_W$CLF_W>1]

ALL4_W$POP_W2[ALL4_W$IPM_W2*ALL4_W$CLF_W1>1]<-(ALL4_W$IPM_W2-ALL4_W$MET_W2)[ALL4_W$IPM_W2*ALL4_W$CLF_W>1]
ALL4_W$POP_W3[ALL4_W$IPM_W3*ALL4_W$CLF_W1>1]<-(ALL4_W$IPM_W3-ALL4_W$MET_W3)[ALL4_W$IPM_W3*ALL4_W$CLF_W>1]
ALL4_W$POP_W4[ALL4_W$IPM_W4*ALL4_W$CLF_W>1]<-(ALL4_W$IPM_W4-ALL4_W$MET_W4)[ALL4_W$IPM_W4*ALL4_W$CLF_W>1]

############################ NOW BRINGING THE FILES BACK TOGETHER

ALL4<-merge(ALL4_M,ALL4_R, by=c("LAT","LON"),all=TRUE,sort=TRUE)
ALL4<-merge(ALL4,ALL4_W, by=c("LAT","LON"),all=TRUE,sort=TRUE)


#CHECK TO MAKE SURE IPM an POP are now correct (turn on to check)
#M2prob <- subset(ALL4,IPM_M2*(CLF_M)>1,select=c(LAT,LON,IPM_M2))
#M3prob <- subset(ALL4,IPM_M3*(CLF_M)>1,select=c(LAT,LON,IPM_M3))
#M4prob <- subset(ALL4,IPM_M4*(CLF_M)>1,select=c(LAT,LON,IPM_M4))
...
ALL4$MET_AVG2<-rowMeans(ALL4[ ,c("MET_M2","MET_R2","MET_W2")],na.rm=TRUE)
ALL4$MET_AVG3<-rowMeans(ALL4[ ,c("MET_M3","MET_R3","MET_W3")],na.rm=TRUE)
ALL4$MET_AVG4<-rowMeans(ALL4[ ,c("MET_M4","MET_R4","MET_W4")],na.rm=TRUE)

ALL4$POP_AVG2<-rowMeans(ALL4[ ,c("POP_M2","POP_R2","POP_W2")],na.rm=TRUE)
ALL4$POP_AVG3<-rowMeans(ALL4[ ,c("POP_M3","POP_R3","POP_W3")],na.rm=TRUE)
ALL4$POP_AVG4<-rowMeans(ALL4[ ,c("POP_M4","POP_R4","POP_W4")],na.rm=TRUE)

ALL4$IPM_AVG2<-rowMeans(ALL4[ ,c("IPM_M2","IPM_R2","IPM_W2")],na.rm=TRUE)
ALL4$IPM_AVG3<-rowMeans(ALL4[ ,c("IPM_M3","IPM_R3","IPM_W3")],na.rm=TRUE)
ALL4$IPM_AVG4<-rowMeans(ALL4[ ,c("IPM_M4","IPM_R4","IPM_W4")],na.rm=TRUE)
...
ALL4[is.na(ALL4$NAME),"NAME"]=NAMES$NAME[NEIGHS$nn.index]

############################### CALCULATING CELL AREA
ALL4$AREA= ((6371^2)*abs((ALL4$LON*pi/180)-((ALL4$LON-0.1667)*pi/180))*abs(sin(ALL4$LAT*pi/180)-sin((ALL4$LAT-0.1667)*pi/180)))*100
...
ALL4$YLD_HA_M<-ALL4$CY_M/ALL4$CA_M
ALL4$YLD_HA_R<-ALL4$CY_R/ALL4$CA_R
ALL4$YLD_HA_W<-ALL4$CY_W/ALL4$CA_W

########YIELD (tonnes) TOTAL PER CELL (YLD_TOT_x)

ALL4$YLD_TOT_M<-ALL4$CY_M*ALL4$AREA
ALL4$YLD_TOT_R<-ALL4$CY_R*ALL4$AREA
ALL4$YLD_TOT_W<-ALL4$CY_W*ALL4$AREA

########TOTAL TONNES LOST PER CELL DUE TO CLIMATE INDUCED CHANGES IN INSECT PESTS (CROP LOSS PER CELL- CL2050_xy)

ALL4$CL2050_M2<-ALL4$IPM_M2*ALL4$CLF_M*ALL4$CY_M*ALL4$AREA
ALL4$CL2050_M3<-ALL4$IPM_M3*ALL4$CLF_M*ALL4$CY_M*ALL4$AREA
ALL4$CL2050_M4<-ALL4$IPM_M4*ALL4$CLF_M*ALL4$CY_M*ALL4$AREA

ALL4$CL2050_R2<-ALL4$IPM_R2*ALL4$CLF_R*ALL4$CY_R*ALL4$AREA
ALL4$CL2050_R3<-ALL4$IPM_R3*ALL4$CLF_R*ALL4$CY_R*ALL4$AREA
ALL4$CL2050_R4<-ALL4$IPM_R4*ALL4$CLF_R*ALL4$CY_R*ALL4$AREA

ALL4$CL2050_W2<-ALL4$IPM_W2*ALL4$CLF_W*ALL4$CY_W*ALL4$AREA
ALL4$CL2050_W3<-ALL4$IPM_W3*ALL4$CLF_W*ALL4$CY_W*ALL4$AREA
ALL4$CL2050_W4<-ALL4$IPM_W4*ALL4$CLF_W*ALL4$CY_W*ALL4$AREA

####### TOTAL EXPECTED PROPORTION OF CROP YIELD LOST  PER HA IN 2050 DUE TO PESTS (CURRENT+ADDEED): CLP2050_xy
ALL4$CLP2050_M2<-ALL4$CLF_M+ALL4$IPM_M2*ALL4$CLF_M
ALL4$CLP2050_M3<-ALL4$CLF_M+ALL4$IPM_M3*ALL4$CLF_M
ALL4$CLP2050_M4<-ALL4$CLF_M+ALL4$IPM_M4*ALL4$CLF_M

ALL4$CLP2050_R2<-ALL4$CLF_R+ALL4$IPM_R2*ALL4$CLF_R
ALL4$CLP2050_R3<-ALL4$CLF_R+ALL4$IPM_R3*ALL4$CLF_R
ALL4$CLP2050_R4<-ALL4$CLF_R+ALL4$IPM_R4*ALL4$CLF_R

ALL4$CLP2050_W2<-ALL4$CLF_W+ALL4$IPM_W2*ALL4$CLF_W
ALL4$CLP2050_W3<-ALL4$CLF_W+ALL4$IPM_W3*ALL4$CLF_W
ALL4$CLP2050_W4<-ALL4$CLF_W+ALL4$IPM_W4*ALL4$CLF_W

#CURRENT CROP YIELD PER HA PLANTED
ALL4$CYH_M<-ALL4$CY_M/ALL4$CA_M
ALL4$CYH_R<-ALL4$CY_R/ALL4$CA_R
ALL4$CYH_W<-ALL4$CY_W/ALL4$CA_W

#PROJECTED FUTURE CROP YIELD PER HA PLANTED
ALL4$FCY_M2<-ALL4$CYH_M*(1-(ALL4$CLF_M*ALL4$IPM_M2))
ALL4$FCY_M3<-ALL4$CYH_M*(1-(ALL4$CLF_M*ALL4$IPM_M3))
ALL4$FCY_M4<-ALL4$CYH_M*(1-(ALL4$CLF_M*ALL4$IPM_M4))

ALL4$FCY_R2<-ALL4$CYH_R*(1-(ALL4$CLF_R*ALL4$IPM_R2))
ALL4$FCY_R3<-ALL4$CYH_R*(1-(ALL4$CLF_R*ALL4$IPM_R3))
ALL4$FCY_R4<-ALL4$CYH_R*(1-(ALL4$CLF_R*ALL4$IPM_R4))

ALL4$FCY_W2<-ALL4$CYH_W*(1-(ALL4$CLF_W*ALL4$IPM_W2))
ALL4$FCY_W3<-ALL4$CYH_W*(1-(ALL4$CLF_W*ALL4$IPM_W3))
ALL4$FCY_W4<-ALL4$CYH_W*(1-(ALL4$CLF_W*ALL4$IPM_W4))
...
ALL4$IYCC_M2<-ALL4$IPM_M2*(ALL4$CLF_M)
ALL4$IYCC_M3<-ALL4$IPM_M3*(ALL4$CLF_M)
ALL4$IYCC_M4<-ALL4$IPM_M4*(ALL4$CLF_M)

ALL4$IYCC_R2<-ALL4$IPM_R2*(ALL4$CLF_R)
ALL4$IYCC_R3<-ALL4$IPM_R3*(ALL4$CLF_R)
ALL4$IYCC_R4<-ALL4$IPM_R4*(ALL4$CLF_R)

ALL4$IYCC_W2<-ALL4$IPM_W2*(ALL4$CLF_W)
ALL4$IYCC_W3<-ALL4$IPM_W3*(ALL4$CLF_W)
ALL4$IYCC_W4<-ALL4$IPM_W4*(ALL4$CLF_W)

#Merge Country to region data
...
ALL4<-merge(C_TO_R,ALL4,"NAME",all=TRUE,sort=TRUE)
#add counting column
ALL4$CELLS<-1

setwd("~/Dropbox/climate change/pest MS shared/four_degree")

write.table(ALL4, file = "ALL4.csv", sep = ",", col.names = NA)

# Load ALL4 -----------------------------------------

setwd("~/Dropbox/climate change/pest MS shared/four_degree")
ALL4<-read.csv("ALL4.csv", header=TRUE,na.strings = c("#VALUE!", "#N/A", "N/A", "NA", ""))

# Total impact on crop production -----------------------------------------
#these produce outputs FOR PAPER, not in a table

#sum(ALL4$YLD_TOT_M*ALL4$CLF_M*ALL4$IPM_M2,na.rm=true) # total tons lost for Maize
#sum(ALL4$YLD_TOT_R*ALL4$CLF_R*ALL4$IPM_R2,na.rm=true)
#sum(ALL4$YLD_TOT_W*ALL4$CLF_W*ALL4$IPM_W2,na.rm=true)

#sum(ALL4$YLD_TOT_M*ALL4$CLF_M*ALL4$IPM_M3,na.rm=true)
#sum(ALL4$YLD_TOT_R*ALL4$CLF_R*ALL4$IPM_R3,na.rm=true)
#sum(ALL4$YLD_TOT_W*ALL4$CLF_W*ALL4$IPM_W3,na.rm=true)

#sum(ALL4$YLD_TOT_M*ALL4$CLF_M*ALL4$IPM_M4,na.rm=true)/sum(ALL4$YLD_TOT_M,na.rm=true)
#sum(ALL4$YLD_TOT_R*ALL4$CLF_R*ALL4$IPM_R4,na.rm=true)/sum(ALL4$YLD_TOT_R,na.rm=true)
#sum(ALL4$YLD_TOT_W*ALL4$CLF_W*ALL4$IPM_W4,na.rm=true)/sum(ALL4$YLD_TOT_W,na.rm=true)
...
# Maize cost
#sum(ALL4$YLD_TOT_M*ALL4$CLF_M*ALL4$IPM_M2,na.rm=true)*321
#sum(ALL4$YLD_TOT_M*ALL4$CLF_M*ALL4$IPM_M3,na.rm=true)*321
#sum(ALL4$YLD_TOT_M*ALL4$CLF_M*ALL4$IPM_M4,na.rm=true)*321

# Rice cost
#sum(ALL4$YLD_TOT_R*ALL4$CLF_R*ALL4$IPM_R2,na.rm=true)*583
#sum(ALL4$YLD_TOT_R*ALL4$CLF_R*ALL4$IPM_R3,na.rm=true)*583
#sum(ALL4$YLD_TOT_R*ALL4$CLF_R*ALL4$IPM_R4,na.rm=true)*583

# Wheat cost
#sum(ALL4$YLD_TOT_W*ALL4$CLF_W*ALL4$IPM_W2,na.rm=true)*305
#sum(ALL4$YLD_TOT_W*ALL4$CLF_W*ALL4$IPM_W3,na.rm=true)*305
#sum(ALL4$YLD_TOT_W*ALL4$CLF_W*ALL4$IPM_W4,na.rm=true)*305
...
####CUT ALL4 ROWS WITH NO LAT AND LONG

ALL4<-subset(ALL4,!is.na(ALL4$LAT))
#NOW RUNNING GRAPHICS
source("~/Dropbox/tewkslab/stats (r code)/functions/color bar.R")
source("~/Dropbox/tewkslab/stats (r code)/functions/summarySE function.R")
source("~/Dropbox/tewkslab/stats (r code)/functions/multiplot.R")
...
#### SETUP MAPPING
# world box
xy.sp= cbind(ALL4$LON, ALL4$LAT)
xy.cc= coordinates(xy.sp)
bbox(xy.sp)
#setup for plotting (making grid)
grd1 <- SpatialPixelsDataFrame(points=xy.sp, data = ALL4[,c(3:113)], tolerance=0.75)
#ONLY NEED THIS ONCE IF WE USE THE ALL4 FILE
...
quants<-c(-Inf,seq(-.5,1,by=.02),Inf) #to specify quant cutoffs
jet.colors <-
...
p_met <- spplot(grd1, 'MET_AVG2', at=quants, sp.layout=list(wrld,txt0), col.regions=cols, cuts=length(cols)-1,colorkey=list(
  space='bottom', width=1, height=0.9, tick.number=9))

png(file="~/Dropbox/climate change/pest MS shared/four_degree/METABOLISM.png", width=900, height=1400) # CHECK RESOLUTION 
print(p_met)
dev.off()
...
png(file="~/Dropbox/climate change/pest MS shared/four_degree/POPULATION AVG P3.png", width=900, height=1400) # CHECK RESOLUTION 
print(pop)
dev.off()

############################# FIG 1C IPM AVERAGE ACROSS ALL4 THREE CROPS####
txt0<-list("sp.text", c(20,-40), "IPM (change in Pest pressure)_AVG")
txt1<-list("sp.text", c(20,-50), "Phi = 0.001")
pop <- spplot(grd1, 'IPM_AVG2', at=quants, sp.layout=list(wrld,txt0,txt1), col.regions=cols, cuts=length(cols)-1,
              colorkey=list(space='bottom', width=1, height=0.9, tick.number=9, labels = list(cex = 1.5)))

png(file="~/Dropbox/climate change/pest MS shared/four_degree/IPM_AVG P3.png", width=900, height=1400) # CHECK RESOLUTION 
print(pop)
dev.off()
...
ALL4$LAT2<-round(ALL4$LAT)
#counting cells for ddply.
ALL4$CELLS_M<-ifelse(is.na(ALL4$POP_M3),0,1)
ALL4$CELLS_R<-ifelse(is.na(ALL4$POP_R3),0,1)
ALL4$CELLS_W<-ifelse(is.na(ALL4$POP_W3),0,1)
LATMEDALL4<-ddply(ALL4,.(LAT2),summarise,
...
LINE1<- melt(LATMEDALL4[ ,c(1:4)], id="LAT2")  # convert to long format
...
LINE1<- melt(LATMEDALL4[ ,c(1,5:7)], id="LAT2")  # convert to long format
...
LINE1<- melt(LATMEDALL4[ ,c(1,8:10)], id="LAT2")  # convert to long format
...
MED_c<-ddply(ALL4,.(NAME),summarise,
...
MED_sr<-ddply(ALL4,.(Subregion),summarise,
              IPM_M2=median(IPM_M2,na.rm=TRUE),
              IPM_M3=median(IPM_M3,na.rm=TRUE),
              IPM_M4=median(IPM_M4,na.rm=TRUE),  
...
MED_r<-ddply(ALL4,.(Region),summarise,
             IPM_M2=median(IPM_M2,na.rm=TRUE),
             IPM_M3=median(IPM_M3,na.rm=TRUE),
             IPM_M4=median(IPM_M4,na.rm=TRUE),  
...
CL_c<-ddply(ALL4,.(NAME),summarise,                       
...
CL_sr<-ddply(ALL4,.(Subregion),summarise,
             MEAN_YLD_HA_M=median(YLD_HA_M,na.rm=TRUE),
             MEAN_YLD_HA_R=median(YLD_HA_R,na.rm=TRUE),
             MEAN_YLD_HA_W=median(YLD_HA_W,na.rm=TRUE),
             TOT_YLD_TOT_M=sum(YLD_TOT_M,na.rm=TRUE),
...
CL_r<-ddply(ALL4,.(Region),summarise,
            MEAN_YLD_HA_M=median(YLD_HA_M,na.rm=TRUE),
            MEAN_YLD_HA_R=median(YLD_HA_R,na.rm=TRUE),
            MEAN_YLD_HA_W=median(YLD_HA_W,na.rm=TRUE),
            TOT_YLD_TOT_M=sum(YLD_TOT_M,na.rm=TRUE),
...
MAIZE<-ALL4[complete.cases(ALL4[ ,7:39]),] # subsets ALL4 to give only maize data
...
RICE<-ALL4[complete.cases(ALL4[ ,40:72]),] # subsets ALL4 to give only maize data
#Got to first calculate sums, then add them back into maize with merge, and then do these calcs.
...
WHEAT<-ALL4[complete.cases(ALL4[ ,73:105]),] # subsets ALL4 to give only maize data
...
MAIZE_r<-ddply(ALL4,.(Region),summarise,                       
...
RICE_r<-ddply(ALL4,.(Region),summarise,                       
...
WHEAT_r<-ddply(ALL4,.(Region),summarise,                       
...
png(file="~/Dropbox/climate change/pest MS shared/MAIZE_Bubble.png", width=600, height=900)
