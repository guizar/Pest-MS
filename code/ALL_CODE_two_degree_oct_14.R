...
#graphics start at 686 (but you need ALL)
#maps start at 686
...
setwd("~/Dropbox/climate change/pest MS shared/Impact_2degC")
...
ALL_R<-subset(ALL,!is.na(ALL$IPM_R2),select=c(LAT,LON,IPM_R2,IPM_R3,IPM_R4,+
...
ALL_W<-subset(ALL,!is.na(ALL$IPM_W2),select=c(LAT,LON,IPM_W2,IPM_W3,IPM_W4,+
...
sum(ALL$YLD_TOT_M*ALL$CLF_M*ALL$IPM_M2,na.rm=true)/sum(ALL$YLD_TOT_M,na.rm=true)
sum(ALL$YLD_TOT_R*ALL$CLF_R*ALL$IPM_R2,na.rm=true)/sum(ALL$YLD_TOT_R,na.rm=true)
sum(ALL$YLD_TOT_W*ALL$CLF_W*ALL$IPM_W2,na.rm=true)/sum(ALL$YLD_TOT_W,na.rm=true)

sum(ALL$YLD_TOT_M*ALL$CLF_M*ALL$IPM_M3,na.rm=true)/sum(ALL$YLD_TOT_M,na.rm=true)
sum(ALL$YLD_TOT_R*ALL$CLF_R*ALL$IPM_R3,na.rm=true)/sum(ALL$YLD_TOT_R,na.rm=true)
sum(ALL$YLD_TOT_W*ALL$CLF_W*ALL$IPM_W3,na.rm=true)/sum(ALL$YLD_TOT_W,na.rm=true)

sum(ALL$YLD_TOT_M*ALL$CLF_M*ALL$IPM_M4,na.rm=true)/sum(ALL$YLD_TOT_M,na.rm=true)
sum(ALL$YLD_TOT_R*ALL$CLF_R*ALL$IPM_R4,na.rm=true)/sum(ALL$YLD_TOT_R,na.rm=true)
sum(ALL$YLD_TOT_W*ALL$CLF_W*ALL$IPM_W4,na.rm=true)/sum(ALL$YLD_TOT_W,na.rm=true)

sum(ALL$YLD_TOT_M*ALL$CLF_M*ALL$IPM_M3,na.rm=true)
sum(ALL$YLD_TOT_R*ALL$CLF_R*ALL$IPM_R3,na.rm=true)
sum(ALL$YLD_TOT_W*ALL$CLF_W*ALL$IPM_W3,na.rm=true)


# Maize cost
#sum(ALL$YLD_TOT_M*ALL$CLF_M*ALL$IPM_M2,na.rm=true)*321
#sum(ALL$YLD_TOT_M*ALL$CLF_M*ALL$IPM_M3,na.rm=true)*321
#sum(ALL$YLD_TOT_M*ALL$CLF_M*ALL$IPM_M4,na.rm=true)*321

# Rice cost
#sum(ALL$YLD_TOT_R*ALL$CLF_R*ALL$IPM_R2,na.rm=true)*583
#sum(ALL$YLD_TOT_R*ALL$CLF_R*ALL$IPM_R3,na.rm=true)*583
#sum(ALL$YLD_TOT_R*ALL$CLF_R*ALL$IPM_R4,na.rm=true)*583

# Wheat cost
#sum(ALL$YLD_TOT_W*ALL$CLF_W*ALL$IPM_W2,na.rm=true)*305
#sum(ALL$YLD_TOT_W*ALL$CLF_W*ALL$IPM_W3,na.rm=true)*305
#sum(ALL$YLD_TOT_W*ALL$CLF_W*ALL$IPM_W4,na.rm=true)*305
