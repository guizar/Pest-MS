...
IPM_REGION_2c_WHEAT$range.2 =paste(IPM_REGION_2c_WHEAT$min.2,IPM_REGION_2c_WHEAT$max.2,sep=",")
IPM_REGION_2c_WHEAT$range.3 =paste(IPM_REGION_2c_WHEAT$min.3,IPM_REGION_2c_WHEAT$max.3,sep=",")
IPM_REGION_2c_WHEAT$range.4 =paste(IPM_REGION_2c_WHEAT$min.4,IPM_REGION_2c_WHEAT$max.4,sep=",")
...
IPM_REGION_2c_WHEAT = IPM_REGION_2c_WHEAT[order(IPM_REGION_2c_WHEAT$median.2,decreasing = T),]
...
YLPH_REGION_2c_WHEAT$range.2 =paste(YLPH_REGION_2c_WHEAT$min.2,YLPH_REGION_2c_WHEAT$max.2,sep=",")
YLPH_REGION_2c_WHEAT$range.3 =paste(YLPH_REGION_2c_WHEAT$min.3,YLPH_REGION_2c_WHEAT$max.3,sep=",")
YLPH_REGION_2c_WHEAT$range.4 =paste(YLPH_REGION_2c_WHEAT$min.4,YLPH_REGION_2c_WHEAT$max.4,sep=",")
...
YL_REGION_PRES_WHEAT$range =paste(YL_REGION_PRES_WHEAT$min,YL_REGION_PRES_WHEAT$max,sep=",")
...
YL_REGION_PRES_WHEAT = dplyr::select(YL_REGION_PRES_WHEAT,-one_of(c("min","max")))
...
IYCC_REGION_2c_WHEAT$range.2 =paste(IYCC_REGION_2c_WHEAT$min.2,IYCC_REGION_2c_WHEAT$max.2,sep=",")
IYCC_REGION_2c_WHEAT$range.3 =paste(IYCC_REGION_2c_WHEAT$min.3,IYCC_REGION_2c_WHEAT$max.3,sep=",")
IYCC_REGION_2c_WHEAT$range.4 =paste(IYCC_REGION_2c_WHEAT$min.4,IYCC_REGION_2c_WHEAT$max.4,sep=",")
...
IYCC_REGION_2c_WHEAT = IYCC_REGION_2c_WHEAT[order(IYCC_REGION_2c_WHEAT$median.2,decreasing = T),]
