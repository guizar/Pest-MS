...
IPM_REGION_2c_WEAT = SUM_IPM_REGION_2c[SUM_IPM_REGION_2c$crop=="W",]

# remove crop col
IPM_REGION_2c_MAIZE = dplyr::select(IPM_REGION_2c_MAIZE,-crop)
IPM_REGION_2c_RICE = dplyr::select(IPM_REGION_2c_RICE,-crop)
IPM_REGION_2c_WEAT = dplyr::select(IPM_REGION_2c_WEAT,-crop)
...
IPM_REGION_2c_WEAT = IPM_REGION_2c_WEAT[,cols]

# concatenate min,max columns
IPM_REGION_2c_MAIZE$range.2 =paste(IPM_REGION_2c_MAIZE$min.2,IPM_REGION_2c_MAIZE$max.2,sep=",")
IPM_REGION_2c_MAIZE$range.3 =paste(IPM_REGION_2c_MAIZE$min.3,IPM_REGION_2c_MAIZE$max.3,sep=",")
IPM_REGION_2c_MAIZE$range.4 =paste(IPM_REGION_2c_MAIZE$min.4,IPM_REGION_2c_MAIZE$max.4,sep=",")

IPM_REGION_2c_RICE$range.2 =paste(IPM_REGION_2c_RICE$min.2,IPM_REGION_2c_RICE$max.2,sep=",")
IPM_REGION_2c_RICE$range.3 =paste(IPM_REGION_2c_RICE$min.3,IPM_REGION_2c_RICE$max.3,sep=",")
IPM_REGION_2c_RICE$range.4 =paste(IPM_REGION_2c_RICE$min.4,IPM_REGION_2c_RICE$max.4,sep=",")

IPM_REGION_2c_WEAT$range.2 =paste(IPM_REGION_2c_WEAT$min.2,IPM_REGION_2c_WEAT$max.2,sep=",")
IPM_REGION_2c_WEAT$range.3 =paste(IPM_REGION_2c_WEAT$min.3,IPM_REGION_2c_WEAT$max.3,sep=",")
IPM_REGION_2c_WEAT$range.4 =paste(IPM_REGION_2c_WEAT$min.4,IPM_REGION_2c_WEAT$max.4,sep=",")
...
IPM_REGION_2c_WEAT = dplyr::select(IPM_REGION_2c_WEAT,-one_of(rem))
rm(rem)


# vertical order by MEDIAN phi 2
IPM_REGION_2c_MAIZE = IPM_REGION_2c_MAIZE[order(IPM_REGION_2c_MAIZE$median.2,decreasing = T),]
IPM_REGION_2c_RICE = IPM_REGION_2c_RICE[order(IPM_REGION_2c_RICE$median.2,decreasing = T),]
IPM_REGION_2c_WEAT = IPM_REGION_2c_WEAT[order(IPM_REGION_2c_WEAT$median.2,decreasing = T),]
...
write.csv(IPM_REGION_2c_WEAT, file.path(wdtables,"ST1_IPM_REGION_2c_WEAT.csv"),row.names=F)

rm(IPM_REGION_2c_MAIZE)
rm(IPM_REGION_2c_RICE)
rm(IPM_REGION_2c_WEAT)
...
TONNES_REGION_2c_WEAT = SUM_TONNES_REGION_2c[SUM_TONNES_REGION_2c$crop=="W",]
...
TONNES_REGION_2c_WEAT = TONNES_REGION_2c_WEAT[,-which(colnames(TONNES_REGION_2c_WEAT) %in% "crop", arr.ind=T)]
...
TONNES_REGION_2c_WEAT$present =TONNES_REGION_PRES_WEAT$sum
...
TONNES_REGION_2c_WEAT = TONNES_REGION_2c_WEAT[order(TONNES_REGION_2c_WEAT$present,decreasing = T),]
...
TONNES_REGION_2c_WEAT = TONNES_REGION_2c_WEAT[,cols]
rm(cols)
...
write.csv(TONNES_REGION_2c_WEAT, file.path(wdtables,"ST2_TONNES_REGION_2c_WEAT.csv"),row.names=F)

rm(TONNES_REGION_2c_MAIZE)
rm(TONNES_REGION_2c_RICE)
rm(TONNES_REGION_2c_WEAT)
...
YLPH_REGION_2c_WEAT = SUM_YLPH_REGION_2c[SUM_YLPH_REGION_2c$crop=="W",]
...
YLPH_REGION_2c_WEAT = dplyr::select(YLPH_REGION_2c_WEAT,-crop)
...
YLPH_REGION_2c_WEAT = YLPH_REGION_2c_WEAT[,cols]
rm(cols)

# concatenate min,max columns
YLPH_REGION_2c_MAIZE$range.2 =paste(YLPH_REGION_2c_MAIZE$min.2,YLPH_REGION_2c_MAIZE$max.2,sep=",")
YLPH_REGION_2c_MAIZE$range.3 =paste(YLPH_REGION_2c_MAIZE$min.3,YLPH_REGION_2c_MAIZE$max.3,sep=",")
YLPH_REGION_2c_MAIZE$range.4 =paste(YLPH_REGION_2c_MAIZE$min.4,YLPH_REGION_2c_MAIZE$max.4,sep=",")

YLPH_REGION_2c_RICE$range.2 =paste(YLPH_REGION_2c_RICE$min.2,YLPH_REGION_2c_RICE$max.2,sep=",")
YLPH_REGION_2c_RICE$range.3 =paste(YLPH_REGION_2c_RICE$min.3,YLPH_REGION_2c_RICE$max.3,sep=",")
YLPH_REGION_2c_RICE$range.4 =paste(YLPH_REGION_2c_RICE$min.4,YLPH_REGION_2c_RICE$max.4,sep=",")

YLPH_REGION_2c_WEAT$range.2 =paste(YLPH_REGION_2c_WEAT$min.2,YLPH_REGION_2c_WEAT$max.2,sep=",")
YLPH_REGION_2c_WEAT$range.3 =paste(YLPH_REGION_2c_WEAT$min.3,YLPH_REGION_2c_WEAT$max.3,sep=",")
YLPH_REGION_2c_WEAT$range.4 =paste(YLPH_REGION_2c_WEAT$min.4,YLPH_REGION_2c_WEAT$max.4,sep=",")
...
YLPH_REGION_2c_WEAT = dplyr::right_join(YL_REGION_PRES_WEAT,YLPH_REGION_2c_WEAT,by = "region")
...
YLPH_REGION_2c_WEAT = dplyr::select(YLPH_REGION_2c_WEAT,-one_of(rem))
rm(rem)
...
YLPH_REGION_2c_WEAT = dplyr::arrange(YLPH_REGION_2c_WEAT, desc(median))
...
write.csv(YLPH_REGION_2c_WEAT, file.path(wdtables,"ST3_YLPH_REGION_2c_WEAT.csv"),row.names=F)

# remove unused
rm(YLPH_REGION_2c_MAIZE)
rm(YLPH_REGION_2c_RICE)
rm(YLPH_REGION_2c_WEAT)
...
IYCC_REGION_2c_WEAT = SUM_IYCC_REGION_2c[SUM_IYCC_REGION_2c$crop=="W",]

# remove crop col
IYCC_REGION_2c_MAIZE = dplyr::select(IYCC_REGION_2c_MAIZE,-crop)
IYCC_REGION_2c_RICE = dplyr::select(IYCC_REGION_2c_RICE,-crop)
IYCC_REGION_2c_WEAT = dplyr::select(IYCC_REGION_2c_WEAT,-crop)

# horizontal re-ordering (columns)
cols = c("region","median.2","median.3","median.4","mean.2","mean.3","mean.4","min.2","max.2","min.3","max.3","min.4","max.4")
IYCC_REGION_2c_MAIZE = IYCC_REGION_2c_MAIZE[,cols]
IYCC_REGION_2c_RICE = IYCC_REGION_2c_RICE[,cols]
IYCC_REGION_2c_WEAT = IYCC_REGION_2c_WEAT[,cols]
rm(cols)

# concatenate min,max columns
IYCC_REGION_2c_MAIZE$range.2 =paste(IYCC_REGION_2c_MAIZE$min.2,IYCC_REGION_2c_MAIZE$max.2,sep=",")
IYCC_REGION_2c_MAIZE$range.3 =paste(IYCC_REGION_2c_MAIZE$min.3,IYCC_REGION_2c_MAIZE$max.3,sep=",")
IYCC_REGION_2c_MAIZE$range.4 =paste(IYCC_REGION_2c_MAIZE$min.4,IYCC_REGION_2c_MAIZE$max.4,sep=",")

IYCC_REGION_2c_RICE$range.2 =paste(IYCC_REGION_2c_RICE$min.2,IYCC_REGION_2c_RICE$max.2,sep=",")
IYCC_REGION_2c_RICE$range.3 =paste(IYCC_REGION_2c_RICE$min.3,IYCC_REGION_2c_RICE$max.3,sep=",")
IYCC_REGION_2c_RICE$range.4 =paste(IYCC_REGION_2c_RICE$min.4,IYCC_REGION_2c_RICE$max.4,sep=",")

IYCC_REGION_2c_WEAT$range.2 =paste(IYCC_REGION_2c_WEAT$min.2,IYCC_REGION_2c_WEAT$max.2,sep=",")
IYCC_REGION_2c_WEAT$range.3 =paste(IYCC_REGION_2c_WEAT$min.3,IYCC_REGION_2c_WEAT$max.3,sep=",")
IYCC_REGION_2c_WEAT$range.4 =paste(IYCC_REGION_2c_WEAT$min.4,IYCC_REGION_2c_WEAT$max.4,sep=",")
...
IYCC_REGION_2c_WEAT = dplyr::select(IYCC_REGION_2c_WEAT,-one_of(rem))
rm(rem)

# vertical order by MEDIAN phi 2
IYCC_REGION_2c_MAIZE = IYCC_REGION_2c_MAIZE[order(IYCC_REGION_2c_MAIZE$median.2,decreasing = T),]
IYCC_REGION_2c_RICE = IYCC_REGION_2c_RICE[order(IYCC_REGION_2c_RICE$median.2,decreasing = T),]
IYCC_REGION_2c_WEAT = IYCC_REGION_2c_WEAT[order(IYCC_REGION_2c_WEAT$median.2,decreasing = T),]
...
write.csv(IYCC_REGION_2c_WEAT, file.path(wdtables,"ST4_IYCC_REGION_2c_WEAT.csv"),row.names=F)

# remove unused
rm(IYCC_REGION_2c_MAIZE)
rm(IYCC_REGION_2c_RICE)
rm(IYCC_REGION_2c_WEAT)
