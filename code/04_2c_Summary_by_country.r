...
IPM_COUNTRY_2c_WEAT = SUM_IPM_COUNTRY_2c[SUM_IPM_COUNTRY_2c$crop=="W",]

# remove crop col
IPM_COUNTRY_2c_MAIZE = dplyr::select(IPM_COUNTRY_2c_MAIZE,-crop)
IPM_COUNTRY_2c_RICE = dplyr::select(IPM_COUNTRY_2c_RICE,-crop)
IPM_COUNTRY_2c_WEAT = dplyr::select(IPM_COUNTRY_2c_WEAT,-crop)
...
IPM_COUNTRY_2c_WEAT = IPM_COUNTRY_2c_WEAT[,cols]
...
IPM_COUNTRY_2c_WEAT$range.2 =paste(IPM_COUNTRY_2c_WEAT$min.2,IPM_COUNTRY_2c_WEAT$max.2,sep=",")
IPM_COUNTRY_2c_WEAT$range.3 =paste(IPM_COUNTRY_2c_WEAT$min.3,IPM_COUNTRY_2c_WEAT$max.3,sep=",")
IPM_COUNTRY_2c_WEAT$range.4 =paste(IPM_COUNTRY_2c_WEAT$min.4,IPM_COUNTRY_2c_WEAT$max.4,sep=",")
...
IPM_COUNTRY_2c_WEAT = dplyr::select(IPM_COUNTRY_2c_WEAT,-one_of(rem))
rm(rem)
...
IPM_COUNTRY_2c_WEAT = IPM_COUNTRY_2c_WEAT[order(IPM_COUNTRY_2c_WEAT$median.2,decreasing = T),]
...
write.csv(IPM_COUNTRY_2c_WEAT, file.path(wdtables,"ST1_IPM_COUNTRY_2c_WEAT.csv"),row.names=F)

rm(IPM_COUNTRY_2c_MAIZE)
rm(IPM_COUNTRY_2c_RICE)
rm(IPM_COUNTRY_2c_WEAT)
...
TONNES_COUNTRY_2c_WEAT = SUM_TONNES_COUNTRY_2c[SUM_TONNES_COUNTRY_2c$crop=="W",]
...
TONNES_COUNTRY_2c_WEAT = TONNES_COUNTRY_2c_WEAT[,-which(colnames(TONNES_COUNTRY_2c_WEAT) %in% "crop", arr.ind=T)]
...
TONNES_COUNTRY_2c_WEAT$present =TONNES_COUNTRY_PRES_WEAT$sum
...
TONNES_COUNTRY_2c_WEAT = TONNES_COUNTRY_2c_WEAT[order(TONNES_COUNTRY_2c_WEAT$present,decreasing = T),]
...
TONNES_COUNTRY_2c_WEAT = TONNES_COUNTRY_2c_WEAT[,cols]
rm(cols)
...
write.csv(TONNES_COUNTRY_2c_WEAT, file.path(wdtables,"ST2_TONNES_COUNTRY_2c_WEAT.csv"),row.names=F)

rm(TONNES_COUNTRY_2c_MAIZE)
rm(TONNES_COUNTRY_2c_RICE)
rm(TONNES_COUNTRY_2c_WEAT)
...
YLPH_COUNTRY_2c_WEAT = SUM_YLPH_COUNTRY_2c[SUM_YLPH_COUNTRY_2c$crop=="W",]
...
YLPH_COUNTRY_2c_WEAT = dplyr::select(YLPH_COUNTRY_2c_WEAT,-crop)
...
YLPH_COUNTRY_2c_WEAT = YLPH_COUNTRY_2c_WEAT[,cols]
rm(cols)
...
YLPH_COUNTRY_2c_WEAT$range.2 =paste(YLPH_COUNTRY_2c_WEAT$min.2,YLPH_COUNTRY_2c_WEAT$max.2,sep=",")
YLPH_COUNTRY_2c_WEAT$range.3 =paste(YLPH_COUNTRY_2c_WEAT$min.3,YLPH_COUNTRY_2c_WEAT$max.3,sep=",")
YLPH_COUNTRY_2c_WEAT$range.4 =paste(YLPH_COUNTRY_2c_WEAT$min.4,YLPH_COUNTRY_2c_WEAT$max.4,sep=",")
...
YLPH_COUNTRY_2c_WEAT = dplyr::right_join(YL_COUNTRY_PRES_WEAT,YLPH_COUNTRY_2c_WEAT,by = "NAME")
...
YLPH_COUNTRY_2c_WEAT = dplyr::select(YLPH_COUNTRY_2c_WEAT,-one_of(rem))
rm(rem)
...
YLPH_COUNTRY_2c_WEAT = dplyr::arrange(YLPH_COUNTRY_2c_WEAT, desc(median))
...
write.csv(YLPH_COUNTRY_2c_WEAT, file.path(wdtables,"ST3_YLPH_COUNTRY_2c_WEAT.csv"),row.names=F)

# remove unused
rm(YLPH_COUNTRY_2c_MAIZE)
rm(YLPH_COUNTRY_2c_RICE)
rm(YLPH_COUNTRY_2c_WEAT)
...
IYCC_COUNTRY_2c_WEAT$range.2 =paste(IYCC_COUNTRY_2c_WEAT$min.2,IYCC_COUNTRY_2c_WEAT$max.2,sep=",")
IYCC_COUNTRY_2c_WEAT$range.3 =paste(IYCC_COUNTRY_2c_WEAT$min.3,IYCC_COUNTRY_2c_WEAT$max.3,sep=",")
IYCC_COUNTRY_2c_WEAT$range.4 =paste(IYCC_COUNTRY_2c_WEAT$min.4,IYCC_COUNTRY_2c_WEAT$max.4,sep=",")
...
IYCC_COUNTRY_2c_WEAT = dplyr::select(IYCC_COUNTRY_2c_WEAT,-one_of(rem))
rm(rem)
...
IYCC_COUNTRY_2c_WEAT = IYCC_COUNTRY_2c_WEAT[order(IYCC_COUNTRY_2c_WEAT$median.2,decreasing = T),]
...
write.csv(IYCC_COUNTRY_2c_WEAT, file.path(wdtables,"ST4_IYCC_COUNTRY_2c_WEAT.csv"),row.names=F)

# remove unused
rm(IYCC_COUNTRY_2c_MAIZE)
rm(IYCC_COUNTRY_2c_RICE)
rm(IYCC_COUNTRY_2c_WEAT)
